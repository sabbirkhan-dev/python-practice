...
def test_length(input_value):
    ...
    assert spellcheck_019.word_count(input_value) < 10
    assert spellcheck_019.char_count(input_value) < 50
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert spellcheck_019.first_char(input_value).isupper()
    assert spellcheck_019.last_char(input_value) == "."
